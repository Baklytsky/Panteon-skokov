...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Left', 'skokov' ),
				'id'            => 'footer-left',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'skokov' ),
				'before_widget' => '<div id="%1$s" class="footer-widget">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<h3 class="footer-headline">',
				'after_title'   => '</h3>',
			)
		);
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Center', 'skokov' ),
				'id'            => 'footer-center',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'skokov' ),
				'before_widget' => '<div id="%1$s" class="footer-widget">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<h3 class="footer-headline text-center">',
				'after_title'   => '</h3>',
			)
		);
